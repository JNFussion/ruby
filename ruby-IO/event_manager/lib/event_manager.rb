...
def legislators_by_zipcode(zip)
    ...
    begin
        civic_info.representative_info_by_address(address: zip, levels: 'country', roles: ['legislatorUpperBody', 'legislatorLowerBody'])
    rescue 
...
max_hours = hours.max_by{ |k,v| v}
max_days = days.max_by{ |k,v| v}
